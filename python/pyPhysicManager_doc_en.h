...
PyDoc_STRVAR(PhysicManager_contactTest_doc,
             ...
             "\n"
             "Parameters:\n"
             "    collisionObject: SceneObject, PhysicObject, or RidgidBody\n"
             "    group: [int] Collision group\n"
             "    mask: [int] Collision mask\n"
             "\n"
             "Return:\n"
...
PyDoc_STRVAR(PhysicManager_contactPairTest_doc,
             ...
             "\n"
             "Parameters:\n"
             "    collisionObjectA: SceneObject, PhysicObject, or RidgidBody\n"
             "    collisionObjectB: SceneObject, PhysicObject, or RidgidBody\n"
             "    group: [int] Collision group\n"
             "    mask: [int] Collision mask\n"
             "\n"
             "Return:\n"
