...
namespace ige::scene
{
    ...
    PyObject *UITextBitmap_getFontPath(PyObject_UITextBitmap *self)
    {
        ...
        return PyUnicode_FromString(std::dynamic_pointer_cast<UITextBitmap>(self->component.lock())->getFontPath().c_str());
    }
    ...
    int UITextBitmap_setFontPath(PyObject_UITextBitmap *self, PyObject *value)
    {
        ...
        if (PyUnicode_Check(value))
        {
            ...
            std::dynamic_pointer_cast<UITextBitmap>(self->component.lock())->setFontPath(std::string(val));
            return 1;
        }
        return 0;
    }
    ...
    {
        if (self->component.expired()) Py_RETURN_NONE;
        return PyUnicode_FromString(std::dynamic_pointer_cast<UITextBitmap>(self->component.lock())->getText().c_str());
    }
    ...
    int UITextBitmap_setText(PyObject_UITextBitmap* self, PyObject* value)
    {
        ...
        {
            const char* val = PyUnicode_AsUTF8(value);
            std::dynamic_pointer_cast<UITextBitmap>(self->component.lock())->setText(std::string(val));
            return 0;
        }
        return -1;
    }
    ...
    {
        if (self->component.expired()) Py_RETURN_NONE;
        return PyLong_FromLong(std::dynamic_pointer_cast<UITextBitmap>(self->component.lock())->getFontSize());
    }
    ...
    int UITextBitmap_setFontSize(PyObject_UITextBitmap* self, PyObject* value)
    {
        ...
        if (PyLong_Check(value))
        {
            ...
            std::dynamic_pointer_cast<UITextBitmap>(self->component.lock())->setFontSize(val);
            return 0;
        }
        return -1;
    }
    ...
    PyObject* UITextBitmap_getColor(PyObject_UITextBitmap* self)
    {
        ...
        vmath_cpy(std::dynamic_pointer_cast<UITextBitmap>(self->component.lock())->getColor().P(), 4, vec4Obj->v);
        vec4Obj->d = 4;
    ...
    int UITextBitmap_setColor(PyObject_UITextBitmap* self, PyObject* value)
    {
        ...
        if (!v)
            return -1;
        std::dynamic_pointer_cast<UITextBitmap>(self->component.lock())->setColor(*((Vec4*)v));
        return 0;
    }
