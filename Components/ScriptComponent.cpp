...
{
    //! Constructor
    ScriptComponent::ScriptComponent(std::shared_ptr<SceneObject> owner, const std::string& path)
    ...
    //! Serialize
    void ScriptComponent::to_json(json& j, const Component& obj)
    {

    }

    //! Deserialize
    void ScriptComponent::from_json(const json& j, Component& obj)
    {
